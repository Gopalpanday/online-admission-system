...
<html>
    ...
    <body onload="validate()">
        ...
        <div style="text-align:center; font-size:16px;">
            ...
            <div style="padding-top: 10px; text-align: center; color: #0186e2;font-weight: bold; font-size: 20px;padding-bottom: 10px;">ALL STUDENTS</div>
            ...
            <%
                ...
                try
                {
                    ...
                    ResultSet rs=st.executeQuery("select * from user ORDER BY u_fname");
                    while(rs.next())
                    {
